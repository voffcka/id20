...
--
-- Хост: localhost
-- Время создания: Окт 20 2016 г., 17:58
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `titlecat` varchar(45) DEFAULT NULL,
...
INSERT INTO `category` (`idcategory`, `titlecat`) VALUES
(1, '1 Категория она же тема'),
(2, '2я Категория она же тема'),
(3, '3я Категоря она же тема');
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  PRIMARY KEY (`idnews`),
  KEY `fk_news_category_idx` (`category_idcategory`),
  KEY `data` (`data`),
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `fk_news_category` FOREIGN KEY (`category_idcategory`) REFERENCES `category` (`idcategory`) ON DELETE NO ACTION ON UPDATE NO ACTION;
